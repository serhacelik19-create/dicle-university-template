    ...
    return (
        <div className="bg-[#F8FAFC] dark:bg-slate-900 rounded-lg p-6 flex flex-col md:flex-row gap-8 items-start justify-between border border-slate-100 dark:border-slate-800">
            ...
            <div className="flex flex-col gap-4 max-w-sm">
                <h3 className="text-[#0f172a] dark:text-white text-xl font-bold">Personel</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                    Akademik ve İdari personel servisleri.
                </p>
                <Link
                    href="/personel"
            ...
            <div className="flex flex-col gap-1 w-full md:w-auto min-w-[200px]">
                ...
                <Link href="#" className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-[var(--primary)] dark:hover:text-[#4F46E5] transition-colors py-1">
                    <ChevronRight size={14} className="text-slate-400" />
                    <span className="text-sm">Personel Bilgi Sistemi (PBS)</span>
                </Link>

                <Link href="#" className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-[var(--primary)] dark:hover:text-[#4F46E5] transition-colors py-1">
                    <ChevronRight size={14} className="text-slate-400" />
                    <span className="text-sm">Kurumsal E-Posta</span>
                </Link>
            </div>
        </div>
    );
